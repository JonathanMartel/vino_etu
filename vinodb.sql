...
CREATE TABLE IF NOT EXISTS `dbs4676326`.`vino__type` (
...
CREATE TABLE IF NOT EXISTS `dbs4676326`.`vino__action` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dbs4676326`.`vino__usager` (
...
CREATE TABLE IF NOT EXISTS `dbs4676326`.`vino__cellier` (
  ...
  CONSTRAINT `fk_cellier_usager`
    ...
    REFERENCES `dbs4676326`.`vino__usager` (`id_usager`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `dbs4676326`.`vino__bouteille` (
  ...
  CONSTRAINT `fk_vino__bouteille_vino__type1`
    ...
    REFERENCES `dbs4676326`.`vino__type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `dbs4676326`.`vino__cellier_historique` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_vino__cellier_mouv_vino__bouteille1`
    ...
    REFERENCES `dbs4676326`.`vino__bouteille` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_vino__cellier_mouv_cellier1`
    FOREIGN KEY (`id_cellier`)
    REFERENCES `dbs4676326`.`vino__cellier` (`id_cellier`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_vino__cellier_mouv_type_mouv1`
    FOREIGN KEY (`action_id`)
    REFERENCES `dbs4676326`.`vino__action` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `dbs4676326`.`vino__cellier_inventaire` (
  `usager_id` INT(11) NOT NULL,
  `id_cellier` INT(11) NOT NULL,
  `bouteille_id` INT(11) NOT NULL,
  `quantite` INT(11) NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_vino__inventaire_cellier_vino__bouteille1`
    ...
    REFERENCES `dbs4676326`.`vino__bouteille` (`usager_id_usager` , `id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `dbs4676326`.`vino__bouteille_saq` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `nom` VARCHAR(200) NULL DEFAULT NULL,
...
INSERT INTO `dbs4676326`.`vino__type` (`type`) VALUES ('vin rouge');
INSERT INTO `dbs4676326`.`vino__type` (`type`) VALUES ('vin blanc');
INSERT INTO `dbs4676326`.`vino__type` (`type`) VALUES ('vin rosé');


INSERT INTO `dbs4676326`.`vino__usager` (`prenom`, `courriel`, `est_admin`) VALUES ('Robert', 'bobus@gmail.com', '1');
