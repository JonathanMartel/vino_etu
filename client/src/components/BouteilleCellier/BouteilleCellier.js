    ...
    const drapeauPays = listePays
      .filter((data) => {
        if (this.props.info.pays == null) return data;
          ...
          data.name.toLowerCase().includes(this.props.info.pays.toLowerCase())
        ) {
          return data;
        }
      })
        ...
        <div className="content_container">
          <div className="content">
            <div className="bouteille_img_container">
              ...
              <img
                src={
                  this.props.info.vino__type_id === "1" ? vinRouge : vinBlanc
                }
              />
            </div>
          ...
          <div className="bouteille_boutons_container">
            ...
            <Link to={"/cellier/bouteilles/" + this.props.info.id}>
              <button className="bouteille_boutons bouton_modifier">
                Modifier
              </button>
            </Link>
          </div>
