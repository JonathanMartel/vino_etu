	...
	render() {
		return (
			<form>
				...
				<p>
					Nom :{' '}
					<input name="nom" value={this.state.nom} onChange={(e) => this.setState({ nom: e.target.value })} />
				</p>
				<p>
					Description :{' '}
					<input
				...
				<p>
					...
					<input
						name="garder"
						value={this.state.garder_jusqua}
						onChange={(e) => this.setState({ garder: e.target.value })}
					/>
				</p>
				<p>
					Note dégustation :{' '}
					<input
						name="note"
						value={this.state.note_degustation}
				...
				<p>
					...
					<input
						...
						onChange={(e) => this.setState({ dateAjout: e.target.value })}
					/>
				</p>
