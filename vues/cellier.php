...
foreach ($data as $cle => $bouteille) {
    ...
    <a class="btnModifier" href='index.php?requete=uneBouteilleCellier&idVin=<?php echo $bouteille['id_bouteille'] ?>&idCellier=<?php echo $bouteille['id_bouteille_cellier'] ?>'>Modifier</a>
        <div class="img">
